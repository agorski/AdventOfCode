...
class Day5Test extends FlatSpec with Matchers {
  ...
  "ugknbfddgicrmopn" should "is nice because it has at least three vowels (u...i...o...), a double letter (...dd...), and none of the disallowed substrings" in {
  ...
  "jchzalrnumimnmhp" should "is naughty because it has no double letter." in {
